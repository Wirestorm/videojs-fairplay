...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Html5Fairplay = function () {
	  ...
	  (0, _createClass3.default)(Html5Fairplay, [{
	    ...
	    value: function onVideoWebkitNeedKey(event) {
	      ...
	      var contentId = this.getKeySessionContentId(event.initData);
	    ...
	    key: 'getKeySessionContentId',
	    value: function getKeySessionContentId(initData) {
	      return (0, _util.getHostnameFromURI)((0, _util.arrayToString)(event.initData));
	    }
	  }, {
	    key: 'src',
    ...
    var mediaSourceMethod = videojs.getTech || videojs.getComponent; // keep it backwards compatible too
